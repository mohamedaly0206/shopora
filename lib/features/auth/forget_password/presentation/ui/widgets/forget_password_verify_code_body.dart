...
class ForgetPasswordVerifyCodeBody extends StatefulWidget {
  const ForgetPasswordVerifyCodeBody({super.key});

  @override
  State<ForgetPasswordVerifyCodeBody> createState() =>
      _ForgetPasswordVerifyCodeBodyState();
}

class _ForgetPasswordVerifyCodeBodyState
    extends State<ForgetPasswordVerifyCodeBody> {
